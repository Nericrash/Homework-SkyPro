...
def test_convert_to_rub(mock_get):
    ...
    mock_get.assert_called_once_with('https://api.apilayer.com/exchangerates_data/convert?to=RUB&from=USD&amount=20', headers={'apikey':None})
#curl --request GET 'https://api.apilayer.com/currency_data/convert?base=USD&symbols=EUR,GBP,JPY&amount=5&date=2018-01-01' \
#--header 'apikey: YOUR API KEY'
#   mock_get.assert_called_once_with('https://api.apilayer.com/exchangerates_data/convert?to=RUB&from=USD&amount=20', headers={'apikey':'GIzNj8Q0aXHOpmFVnItJCKHMiKXvd5CR'})