...
def test_get_transactions_dictionary(get_wrong_path: str) -> Any:
...
def test_convert_to_rub(mock_get):
    ...
    mock_get.assert_called_once_with(
        "https://api.apilayer.com/exchangerates_data/convert?to=RUB&from=USD&amount=20", headers={"apikey": None}
    )
